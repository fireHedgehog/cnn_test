...
df = get_data_by_file_name('crossover_0_6.txt')
df1 = get_data_by_file_name('../population-data/01-07-100-300.txt')
df1 = df1.head(110)
df2 = get_data_by_file_name('cross_08.txt')
...
fig.suptitle('Crossover Rate Comparision for Accordion Encoding ( CIFAR-10 )', y=1, fontsize=16)
...
axs[0].legend(['Crossover Rate=0.6', 'Mutation Rate=0.7', 'Mutation Rate=0.8'], loc='upper left')
...
axs[1].legend(['Crossover Rate=0.6', 'Mutation Rate=0.7', 'Mutation Rate=0.8'], loc='upper left')
