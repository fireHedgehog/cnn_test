...
def main():
    ...
    train_dataset_paths = ['./dog_cat_data/train/cat/',
                           './dog_cat_data/train/dog/']  # 指定训练集数据路径（根据实际情况指定训练数据集的路径）
    test_dataset_paths = ['./dog_cat_data/test/cat/',
                          './dog_cat_data/test/dog/']  # 指定测试集数据路径（根据实际情况指定测试数据集的路径）
